...
In this assessment, the names are more suitable for a real-world scenario. The project is named  **little_lemon** , and the app inside the project is named  **restaurant**. And these are already created.
